...
_import_structure = {
    "configuration_rnabert": ["RNABERT_PRETRAINED_CONFIG_ARCHIVE_MAP", "RNABertConfig"],
...
try:
    ...
    _import_structure["modeling_rnabert"] = [
        "RNABERT_PRETRAINED_MODEL_ARCHIVE_LIST",
        "RNABertForCausalLM",
        "RNABertForMaskedLM",
        "RNABertForMultipleChoice",
        "RNABertForNextSentencePrediction",
        "RNABertForPreTraining",
        "RNABertForQuestionAnswering",
...
if TYPE_CHECKING:
    from .configuration_rnabert import (
